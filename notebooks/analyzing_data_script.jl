...
all_categories = data_analysis |> 
    ...
    @map({_.Age, _.Photoreceptors, _.Wavelength, _.Rearing}) |>
    DataFrame
...
all_categories  = all_categories |> @orderby_descending(_.Rearing) |> @thenby(_.Age) |> @thenby_descending(_.Photoreceptors) |> @thenby(_.Wavelength) |> DataFrame
